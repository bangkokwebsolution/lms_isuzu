...
(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                (options.horizontal == false ? '   <div class="col-md-4">' : '   <div class="col-md-6">') +
                ...
                '       <select class="unselected" style="height: 200px; width: 100%;" multiple name="unselected_mail[]"></select>' +
                '   </div>' +
                ...
                '       <select class="selected" style="height: 200px; width: 100%;" multiple name="selected_mail[]"></select>' +
                '   </div>');
    ...
    function createHorizontalButtons(number, copyAllBtn) {
        if (number == 1) {
            ...
            return '       <button type="button" class="btn btn-default ' + (copyAllBtn ? 'col-md-6' : 'col-md-12') + ' stl" data-type="stl" style="margin-bottom: 5px;" disabled><span class="glyphicon glyphicon-chevron-left"></span></button>' +
                (copyAllBtn ? '       <button type="button" class="btn btn-default col-md-6 pull-right atl" data-type="atl" style="margin-bottom: 5px;"><span class="glyphicorginyphicon-chevron-left"></span> <span class="glyphicon glyphicon-list"></span></button>' : '');
        }
    }
