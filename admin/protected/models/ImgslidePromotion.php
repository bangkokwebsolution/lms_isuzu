...
class ImgslidePromotion extends AActiveRecord
{
    ...
    public function checkScopes($check = 'scopes')
    {
    	...
    	{
		    $checkScopes =  array(
		    	'alias' => 'imgslidepromotions',
		    	'order' => ' imgslidepromotions.imgslide_id DESC ',
		    	'condition' => ' imgslidepromotions.active ="y" ',
		    );	
    	}
    	else
    	{
	...
	public function scopes()
    {
		...
		$Access = Controller::SetAccess( array("ImgslidePromotion.*") );
		if($Access == true)
		{
			$scopes =  array( 
				'imgslidepromotioncheck' => $this->checkScopes('scopes') 
			);
		}
		else
		{
			...
			{
			    $scopes = array(
		            'imgslidepromotioncheck'=>array(
				    	'alias' => 'imgslidepromotions',
				    	'condition' => ' imgslidepromotions.create_by = "'.Yii::app()->user->id.'" AND imgslidepromotions.active ="y" ',
				    	'order' => ' imgslidepromotions.imgslide_id DESC ',
		            ),
			    );
			}
