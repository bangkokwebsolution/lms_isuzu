...
class ImgslideCourse extends AActiveRecord
{
    ...
    public function checkScopes($check = 'scopes')
    {
    	...
    	{
		    $checkScopes =  array(
		    	'alias' => 'imgslidecourses',
		    	'order' => ' imgslidecourses.imgslide_id DESC ',
		    	'condition' => ' imgslidecourses.active ="y" ',
		    );	
    	}
    	else
    	{
	...
	public function scopes()
    {
		...
		$Access = Controller::SetAccess( array("ImgslideCourse.*") );
		if($Access == true)
		{
			$scopes =  array( 
				'imgslidecoursecheck' => $this->checkScopes('scopes') 
			);
		}
		else
		{
			...
			{
			    $scopes = array(
		            'imgslidecoursecheck'=>array(
				    	'alias' => 'imgslidecourses',
				    	'condition' => ' imgslidecourses.create_by = "'.Yii::app()->user->id.'" AND imgslidecourses.active ="y" ',
				    	'order' => ' imgslidecourses.imgslide_id DESC ',
		            ),
			    );
			}
