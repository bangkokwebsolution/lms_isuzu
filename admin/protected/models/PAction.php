 ...
 */
class PAction extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('create_date, update_date, create_by, update_by', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, controller_id, title, action, create_date, create_by, update_date, update_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'pController' => array(self::HAS_ONE, 'PController', 'controller_id'),
		);
	}
