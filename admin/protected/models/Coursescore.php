...
class Coursescore extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('score_id, course_id, user_id, score_number,score_total, create_date, create_by, update_date, update_by, active, gen_id, type ,refer_status', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('refer_status',$this->refer_status,true);
