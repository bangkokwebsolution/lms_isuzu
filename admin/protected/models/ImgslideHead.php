...
class ImgslideHead extends AActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('imgslide_id , imgslide_link', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function checkScopes($check = 'scopes')
    {
    	if ($check == 'scopes')
    	{
		    $checkScopes =  array(
		    	'alias' => 'imgslideheads',
		    	'condition' => ' imgslideheads.active = "y" ',
		    	'order' => ' imgslideheads.imgslide_id DESC ',
		    );	
    	}
    	else
    	{
	...
	public function scopes()
    {
		...
		$Access = Controller::SetAccess( array("ImgslideHead.*") );
		if($Access == true)
		{
			$scopes =  array( 
				'imgslideheadcheck' => $this->checkScopes('scopes') 
			);
		}
		else
		{
			...
			{
			    $scopes = array(
		            'imgslideheadcheck'=>array(
			    		'alias' => 'imgslideheads',
			    		'condition' => ' imgslideheads.create_by = "'.Yii::app()->user->id.'" AND imgslideheads.active = "y" ',
			    		'order' => ' imgslideheads.imgslide_id DESC ',
		            ),
			    );
			}
