...
class MenuSearch extends CActiveRecord
{
	...
	{
		return array(
			'label_search_result' => 'ผลการค้นหา',
			'label_homepage' => 'หน้าแรก',
			'label_searchAll' => 'ผลลัพธ์ทั้งหมด',
			'label_list' => 'รายการ',
			'label_result' => 'วิธีการใช้งาน',
			'label_usability' => 'วิธีการใช้งาน',
			'label_news' => 'ข่าวประชาสัมพันธ์',
			'label_courseOnline' => 'หลักสูตร',
			'label_vdo' => 'วีดีโอแน่ะนำ',
			'label_document' => 'เอกสารเผยแพร่',
