...
class Knowledge extends AActiveRecord
{
    ...
    public function checkScopes($check = 'scopes')
    {
    	if ($check == 'scopes')
    	{
		    $checkScopes =  array(
		    	'alias' => 'knowledges',
		    	'order' => ' knowledges.cms_id DESC ',
		    	'condition' => ' knowledges.active ="y" ',
		    );	
    	}
    	else
    	{
	...
	public function scopes()
    {
		...
		$Access = Controller::SetAccess( array("Knowledge.*") );
		if($Access == true)
		{
			$scopes =  array( 
				'knowledgecheck' => $this->checkScopes('scopes') 
			);
		}
		else
		{
			...
			else
			{
			    $scopes = array(
		            'knowledgecheck'=>array(
			    		'alias' => 'knowledges',
			    		'condition' => ' knowledges.create_by = "'.Yii::app()->user->id.'" AND knowledges.active ="y" ',
			    		'order' => ' knowledges.cms_id DESC ',
		            ),
			    );
			}
