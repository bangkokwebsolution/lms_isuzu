				...
				<div id="question-list">
					<div class="question-group" data-index="<?php echo $modelQues->ques_id; ?>">
                        ...
                        <div class="row question">
                            ...
                            <div class="span12">
                                <textarea name="Explain[<?php echo $modelQues->ques_id; ?>]" class="question-title" id="question-<?php echo $modelQues->ques_id; ?>-explain" cols="30" rows="10"><?php echo $modelQues->ques_explain; ?></textarea>
                            </div>
                        </div>
