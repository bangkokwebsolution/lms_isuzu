        ...
        <div class="widget-body">
            <div class="form">
               ...
               <?php } ?>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_search_result'); ?>
                    <?php echo $form->textField($label, 'label_search_result', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_search_result'); ?>
                </div>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_searchAll'); ?>
                    <?php echo $form->textField($label, 'label_searchAll', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_searchAll'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_list'); ?>
                    <?php echo $form->textField($label, 'label_list', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                ...
                <div class="row">
                    ...
                    <?php echo $form->textField($label, 'label_result', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_result'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_usability'); ?>
                    <?php echo $form->textField($label, 'label_usability', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_usability'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_news'); ?>
                    <?php echo $form->textField($label, 'label_news', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_news'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_courseOnline'); ?>
                    <?php echo $form->textField($label, 'label_courseOnline', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_courseOnline'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_vdo'); ?>
                    <?php echo $form->textField($label, 'label_vdo', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_vdo'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_document'); ?>
                    <?php echo $form->textField($label, 'label_document', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_document'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_imgslide'); ?>
                    <?php echo $form->textField($label, 'label_imgslide', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
