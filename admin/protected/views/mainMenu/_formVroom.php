        ...
        <div class="widget-body">
            <div class="form">
                ...
                <div class="row" id="url">
                    ...
                    <?php echo $form->textField($model, 'url', array('size' => 60, 'class' => 'span8','readonly' => true)); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($model, 'url'); ?>
                </div>
               <?php } ?>
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_vroom'); ?>
                    <?php echo $form->textField($label, 'label_vroom', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_vroom'); ?>
                </div>
