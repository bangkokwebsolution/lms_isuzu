        ...
        <div class="widget-body">
            ...
            <!--     <div class="row">
               ...
               <?php } ?>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_library_document'); ?>
                    <?php echo $form->textField($label, 'label_library_document', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_library_document'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_library_media'); ?>
                    <?php echo $form->textField($label, 'label_library_media', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_library_media'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_list_docment'); ?>
                    <?php echo $form->textField($label, 'label_list_docment', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_list_docment'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_list_media'); ?>
                    <?php echo $form->textField($label, 'label_list_media', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_list_media'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_all'); ?>
                    <?php echo $form->textField($label, 'label_all', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_all'); ?>
                </div>
