    ...
    <div class="widget widget-tabs border-bottom-none">
        ...
        <div class="widget-body">
            <div class="form">
               ...
               <?php } ?>
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_privatemessage'); ?>
                    <?php echo $form->textField($label, 'label_privatemessage', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_privatemessage'); ?>
                </div>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_reply'); ?>
                    <?php echo $form->textField($label, 'label_reply', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_reply'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_sendMess'); ?>
                    <?php echo $form->textField($label, 'label_sendMess', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_sendMess'); ?>
                </div>

                <h4 class="labelCourse"><i class="fa fa-commenting-o" aria-hidden="true"></i>&nbsp; หน้าต่างสร้างข้อความใหม่<h4>

                    <div class="row">

                        <div class="col-md-4">
                            <?php echo $form->labelEx($label, 'label_createMsg'); ?>
                            <?php echo $form->textField($label, 'label_createMsg', array('size' => 60, 'maxlength' => 250, 'class' => 'width600')); ?>
                            <?php echo $this->NotEmpty(); ?>
                            <?php echo $form->error($label, 'label_createMsg'); ?>
                        </div>

                        <div class="col-md-4">
                            <?php echo $form->labelEx($label, 'label_receiver'); ?>
                            <?php echo $form->textField($label, 'label_receiver', array('size' => 60, 'maxlength' => 250, 'class' => 'width600')); ?>
                            <?php echo $this->NotEmpty(); ?>
                            <?php echo $form->error($label, 'label_receiver'); ?>
                        </div>

                        <div class="col-md-4">
                            <?php echo $form->labelEx($label, 'label_topic'); ?>
                            <?php echo $form->textField($label, 'label_topic', array('size' => 60, 'maxlength' => 250, 'class' => 'width600')); ?>
                            <?php echo $this->NotEmpty(); ?>
                        ...
                        <div class="col-md-4">
                            <?php echo $form->labelEx($label, 'label_notification'); ?>
                            <?php echo $form->textField($label, 'label_notification', array('size' => 60, 'maxlength' => 250, 'class' => 'width600')); ?>
                            <?php echo $this->NotEmpty(); ?>
                            <?php echo $form->error($label, 'label_notification'); ?>
                        </div>
                        
                        <div class="col-md-4">
                            <?php echo $form->labelEx($label, 'label_uploadFile'); ?>
                            <?php echo $form->textField($label, 'label_uploadFile', array('size' => 60, 'maxlength' => 250, 'class' => 'width600')); ?>
                            <?php echo $this->NotEmpty(); ?>
                            <?php echo $form->error($label, 'label_uploadFile'); ?>
                        </div>

                        <div class="col-md-12">
                            <?php echo $form->labelEx($label, 'label_notfiToEmail'); ?>
                            <?php echo $form->textField($label, 'label_notfiToEmail', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                            <?php echo $this->NotEmpty(); ?>
                            <?php echo $form->error($label, 'label_notfiToEmail'); ?>
                        </div>
