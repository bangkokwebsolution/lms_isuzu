    ...
    <div class="widget widget-tabs border-bottom-none">
        ...
        <div class="widget-body">
            <div class="form">
               ...
               <?php } ?>
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_about'); ?>
                    <?php echo $form->textField($label, 'label_about', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_about'); ?>
                </div>
