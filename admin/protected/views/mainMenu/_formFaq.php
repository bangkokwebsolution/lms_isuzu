        ...
        <div class="widget-body">
            <div class="form">
               ...
               <?php } ?>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_faq'); ?>
                    <?php echo $form->textField($label, 'label_faq', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_faq'); ?>
                </div>
                ...
                <div class="row">
                    <?php echo $form->labelEx($label, 'label_ques'); ?>
                    <?php echo $form->textField($label, 'label_ques', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_ques'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_ans'); ?>
                    <?php echo $form->textField($label, 'label_ans', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_ans'); ?>
                </div>

                <div class="row">
                    <?php echo $form->labelEx($label, 'label_noTopic'); ?>
                    <?php echo $form->textField($label, 'label_noTopic', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_noTopic'); ?>
                </div>

                 <div class="row">
                    <?php echo $form->labelEx($label, 'label_noDetail'); ?>
                    <?php echo $form->textField($label, 'label_noDetail', array('size' => 60, 'maxlength' => 250, 'class' => 'span8')); ?>
                    <?php echo $this->NotEmpty(); ?>
                    <?php echo $form->error($label, 'label_noDetail'); ?>
                </div>
