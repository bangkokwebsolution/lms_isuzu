                    ...
                    'htmlOptions'=>array('style'=>'text-align: center','width'=>$this->getWidthColumnLang().'px;'),
						...
						array(
							...
							'value'=>function($data){
								...
								$text .= '
								<a class="btn-action glyphicons eye_open btn-info" title="ดูรายละเอียด" href="'.Yii::app()->controller->createUrl('terms/'.$data->id).'"><i></i></a>
								<a class="btn-action glyphicons pencil btn-success" title="แก้ไข" href="'.Yii::app()->controller->createUrl('terms/update/'.$data->id).'"><i></i></a>
								';
