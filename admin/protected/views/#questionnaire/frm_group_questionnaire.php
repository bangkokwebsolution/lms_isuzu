    ...
    <div class="widget" style="margin-top: -1px;">
        ...
        <div class="widget-body">
            <div class="row-fluid">
                ...
                <?php echo CHtml::tag('th', array(), 'วันที่เริ่ม'); ?>
                <?php echo CHtml::tag('th', array(), 'ถึงวันที่'); ?>
                ...
                foreach ($model as $rows) {
                    ...
                    //Name TH
                    echo CHtml::tag('td', array(), $rows->Gna_cNameTH);
                    //Name EN
                    echo CHtml::tag('td', array(), $rows->Gna_cNameEN);
                    //Start Date
                    echo CHtml::tag('td', array(), $rows->Gna_dStart);
                    //End Date
                    echo CHtml::tag('td', array(), $rows->Gna_dEnd);
                    //View
                    echo CHtml::tag('td', array(),
                        CHtml::link(CHtml::image('../images/image2.png'),
                            array('Questionnaire/ManageTitleQuestion', 'stat' => 'VIEW', 'id' => $rows->Gna_nID))
                    );
                    //Edit
                    echo CHtml::tag('td', array(),
                        CHtml::link(CHtml::image('../images/image2.png'),
                            array('Questionnaire/ManageTileQuestion', 'stat' => 'EDIT', 'id' => $rows->Gna_nID))
                    );
                    //Delete
                    echo CHtml::tag('td', array(),
                        CHtml::link(CHtml::image('../images/image2.png'),
                            array('Questionnaire/ManageTitleQuestion', 'stat' => 'DEL', 'id' => $rows->Gna_nID))
                    );
    ...
    $(document).ready(function () {
        $("#txtSearch").keyup(function () {
            if ($('#txtSearch').val().length > 0) {
                $.post("index.php?r=Questionnaire/ACGroupQuestionnaire", {
