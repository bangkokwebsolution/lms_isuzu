...
<div class="widget" style="margin-top: -1px;">
    ...
    <div class="widget-body">
        <div class="row-fluid">
            ...
            <?php echo CHtml::tag('th', array(), 'คำถาม TH'); ?>
            <?php echo CHtml::tag('th', array(), 'คำถาม EN'); ?>
            ...
            foreach ($model as $rows) {
                ...
                //Name TH
                echo CHtml::tag('td', array(), $rows->Que_cNameTH);
                //Name EN
                echo CHtml::tag('td', array(), $rows->Que_cNameEN);
                //View
                echo CHtml::tag('td', array(),
                    CHtml::link(CHtml::image(Yii::app()->theme->baseUrl.'/theme/images/icon/view.png'),
                        array('Questionnaire/ManageQuestion', 'stat' => 'VIEW', 'id' => $rows->Que_nID))
                );
                //Edit
                echo CHtml::tag('td', array(),
                    CHtml::link(CHtml::image(Yii::app()->theme->baseUrl.'/theme/images/icon/edit.png'),
                        array('Questionnaire/ManageQuestion', 'stat' => 'EDIT', 'id' => $rows->Que_nID))
                );
                //Delete
                echo CHtml::tag('td', array(),
                    CHtml::link(CHtml::image(Yii::app()->theme->baseUrl.'/theme/images/icon/del.png'),
                        array('Questionnaire/ManageQuestion', 'stat' => 'DEL', 'id' => $rows->Que_nID))
                );
            ...
            if ($countpage > 1) {
                ...
                echo "<div id='page' style='padding-left:50%;'>";
                for ($i = 1; $i <= $countpage; $i++) {

                    echo CHtml::link(CHtml::button($i, array('class' => 'btn btn-primary', 'style' => 'margin-left:10px;')),
                        array('Questionnaire/Question', 'page' => $i, 'filter' => $filter)
                    );
            ...
            echo CHtml::link(CHtml::button('เพิ่มข้อมูล', array('class' => 'btn btn-primary')),
                array('Questionnaire/ManageQuestion', 'stat' => 'ADD')
            );
            echo CHtml::link(CHtml::button('ลบทั้งหมด', array('class' => 'btn btn-primary', 'style' => 'margin-left:10px;')),
                array('Questionnaire/ManageQuestion', 'stat' => 'DELALL'
    ...
    $(document).ready(function () {
        $("#txtSearch").keyup(function () {
            if ($('#txtSearch').val().length > 0) {
                $.post("index.php?r=Questionnaire/ACQuestion", {
