...
$columns=array(
    ...
    array(
        ...
        'footer'=>'ผลรวม: ' . $model->getTotal($id,$ans,"5"),
    ),
    array(
        'header'=>'มาก (4)',
        'name'=>'eval_answer',
        ...
        'footer'=>'ผลรวม: ' . $model->getTotal($id,$ans,"4"),
    ),
    array(
        'header'=>'ปานกลาง (3)',
        'name'=>'eval_answer',
        ...
        'footer'=>'ผลรวม: ' . $model->getTotal($id,$ans,"3"),
    ),
    array(
        'header'=>'น้อย (2)',
        'name'=>'eval_answer',
        ...
        'footer'=>'ผลรวม: ' . $model->getTotal($id,$ans,"2"),
    ),
    array(
        'header'=>'น้อยที่สุด (1)',
        'name'=>'eval_answer',
        ...
        'footer'=>'ผลรวม: ' . $model->getTotal($id,$ans,"1"),
    ),
);
?>
...
<?php $this->widget('application.components.widgets.tlbExcelView', array(
    'id'                   => 'Order-grid',
    'dataProvider'         => $model->search($id,$ans),
