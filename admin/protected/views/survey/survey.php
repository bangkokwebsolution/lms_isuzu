<div class="innerLR">
    ...
    <div class="widget" style="margin-top: -1px;">
        <div class="widget-head">
            <h4 class="heading glyphicons show_thumbnails_with_lines"><i></i>แบบสอบถาม</h4>
        </div>
            ...
            <div class="separator bottom form-inline small">
                <span class="pull-right" style="margin-left: 10px;">
					<a class="btn btn-primary btn-icon glyphicons circle_plus"
                       ...
                       href="<?php echo $this->createUrl('survey/creategroupsurvey'); ?>"><i></i> เพิ่มชุดแบบสอบถาม</a>
                </span>
