            ...
            <table class="table table-bordered toggleairasia-table">
                ...
                <thead>
                    <tr style="background-color: #e476e8;">
                        ...
                        <th  style="vertical-align: middle;" class="center"><b>วันที่สอบ</b></th>
                        <th  style="vertical-align: middle;" class="center"><b>คะแนน</b></th>
                    </tr>
                </thead>
                <!-- // Table heading END -->
                 <?php 
                if($model){
                 foreach($model as $key => $value) { ?>
                    <tr>
                        ...
                        <td><center><?= $value->score_number.'/'.$value->score_total; ?></td>
                    </tr>
                <?php }
                } else {
                ?>
...
<div class="widget-body">
            <button type="button" id="btnExport" class="btn btn-primary btn-icon glyphicons file"><i></i> Export</button>
                <a href="<?= $this->createUrl('report/genpdftestscore',array('id'=>$_GET['id'],
