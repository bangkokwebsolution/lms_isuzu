            ...
            <table class="table table-bordered toggleairasia-table" style="width: 100%">
                ...
                <thead>
                    <tr style="background-color: #e476e8;">
                        ...
                        <th  style="vertical-align: middle; border: 0.2px solid #000; " class="center"><b>วันที่สอบ</b></th>
                        <th  style="vertical-align: middle; border: 0.2px solid #000; " class="center"><b>คะแนน</b></th>
                    </tr>
                </thead>
                <!-- // Table heading END -->
                 <?php 
                if($model){
                 foreach($model as $key => $value) { ?>
                    <tr>
                        ...
                        <td  style="border: 0.2px solid #000;" ><center><?= $value->score_number.'/'.$value->score_total; ?></td>
                    </tr>
                <?php }
                } else {
                ?>
