    ...
    <div class="widget-body collapse">
        <dl class="dl-horizontal">
            <div class="form-group">
                ...
                <dd>
                    <select name="ReportUser[generation]">
            ...
            <div class="form-group">
                ...
                <dd>
                    <select name="ReportUser[course][]" multiple style="width: 50%; height: 150px;" id="courseSelectMulti">
                    <?php
            ...
            <div class="form-group">
                <dt><label>เลือกสถานะ : </label></dt>
                <dd>
                    <select name="ReportUser[status_learn]">
                        <option value="">--- สถานะทั้งหมด ---</option>
                        <option value="notLearn">ไม่เข้าเรียน</option>
                        <option value="learning">กำลังเรียน</option>
                        <option value="pass">เรียนผ่าน</option>
                    </select>
                </dd>
            </div>
            <div class="form-group">
                ...
                <dd>
                    <div>
                        <input name="ReportUser[nameIdenSearch]" type="text" value="" placeholder="ค้นหาด้วยชื่อ, สกุล หรือบัตรประชาชน">
                    </div>
            ...
            <div class="form-group">
                ...
                <dd>
                    <input name="ReportUser[date_start]" type="text" class="form-control" placeholder="เลือกช่วงเวลาเริ่ม" id="passcoursStartDateBtn"> : <input name="ReportUser[date_end]" type="text" class="form-control" placeholder="เลือกช่วงเวลาสิ้นสุด" id="passcoursEndDateBtn">
                </dd>
            </div>
            <div class="form-group">
                <dt></dt>
