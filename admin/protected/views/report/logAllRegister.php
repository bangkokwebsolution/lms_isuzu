    ...
    $this->widget('AdvanceSearchForm', array(
        ...
        'attributes' => array(
           ...
           // array('name' => 'division_id', 'type' => 'list', 'query' => $model->getDivisionList()),
            array('name' => 'department', 'header' => 'ฝ่าย/แผนก', 'type' => 'list', 'query' => $depList),
                    ...
                    <div class="widget-body" style=" overflow-x: scroll;">
                        ...
                        <div class="overflow-table">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="10" style="background-color:burlywood;"><b><?php $emptype = TypeEmployee::model()->findByPk($_GET['ReportUser']['employee_type']); echo $emptype->type_employee_name; ?></b></td>
                                    </tr>
                                    <?php $regispass = 0; 
                                    ...
                                    <?php 
                                    // จำนวนทั้งหมด
                                    $total_re_total = 0; $total_accept_total = 0;
                                            ...
                                            for($i = 0; $i < count($PositionAll); $i ++){ ?>
                                                <tr>
                                                    <?php 
                                                        ...
                                                        ?>
                                                        <td></td>
                                                        <td><?php if ($Setdep == 0) { echo $value->dep_title; $Setdep = 1;}?></td>
                                        ...
                                        for($i = 0; $i < count($DivisionAll); $i ++){ 
                                            ...
                                            <?php for ($n = 0; $n < count($PosAll); $n++){
                                                ...
                                                <?php for ($x = 0; $x < count($levelAll); $x++){ ?>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td><?php if ($Setdiv == 0) { echo $DivisionAll[$i]['dep_title']; $Setdiv = 1;} ?></td>
                                                        <td><?php if ($Setpos == 0) { echo $PosAll[$n]['position_title']; $Setpos = 1;} ?></td>
