            ...
            <table class="table table-bordered" style="table-layout: fixed;">
                ...
                <tbody>
                    ...
                    <?php foreach ($model as $key => $value) {
                     ...
                     <tr>
                        ...
                        <td class="center"><?= $value->result; ?>/<?= $value->questions->max_score; ?>
                        </td>
                         <td width="10%" class="text-center" style="vertical-align: middle;">
                            ...
                            <input type="number" style="width: 100%;" name=logques_id[<?= $value->logques_id; ?>] min="0" max=<?= $value->questions->max_score; ?> placeholder="  ให้คะแนนใหม่" required value=<?= $value->result; ?> >
                ...
                ?>
                    <tr>
                        ...
                        <td class="center"><?= $model[0]->Coursescore->score_number; ?>/<?= $model[0]->Coursescore->score_total; ?>
                        </td>
                    </tr>
