...
<div class="innerLR">
		...
		<div class="widget-body">
			...
			<div class="overflow-table">
				<?php $this->widget('AGridView', array(
					...
					'dataProvider'=>$model->promotions()->search(),
					'filter'=>$model,
					'selectableRows' => 2,	
					'htmlOptions' => array(
					...
					'columns'=>array(
						array(
							'visible'=>Controller::DeleteAll(
								array("Promotion.*", "Promotion.Delete", "Promotion.MultiDelete")
							),
						...
						/*array(
							'name'=>'shop_point',
							'value'=>'number_format($data->shop_point)'
						),
				        array(
				        	'name'=>'shop_status',
				        	'class'=>'JToggleColumn',
						...
						array(            
							...
							'visible'=>Controller::PButton( 
								array("Promotion.*", "Promotion.View", "Promotion.Update", "Promotion.Delete") 
							),
							'buttons' => array(
								'view'=> array( 
									'visible'=>'Controller::PButton( array("Promotion.*", "Promotion.View") )' 
								),
								'update'=> array( 
									'visible'=>'Controller::PButton( array("Promotion.*", "Promotion.Update") )' 
								),
								'delete'=> array( 
									'visible'=>'Controller::PButton( array("Promotion.*", "Promotion.Delete") )' 
								),
							),
						),
					),
	...
	<?php if( Controller::DeleteAll(array("Promotion.*", "Promotion.Delete", "Promotion.MultiDelete")) ) : ?>
		<!-- Options -->
