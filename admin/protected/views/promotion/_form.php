		...
		<div class="widget-body">
			...
			<?php $form = $this->beginWidget('AActiveForm', array(
				...
				<p class="note">ค่าที่มี <?php echo $this->NotEmpty();?> จำเป็นต้องใส่ให้ครบ</p>
					...
					<div class="row">
						<?php //echo $form->labelEx($model,'shop_point'); ?>
						<?php //echo $form->textField($model,'shop_point',array('size'=>60,'maxlength'=>250, 'class'=>'span8')); ?>
						<?php //echo $this->NotEmpty();?>
						<?php //echo $form->error($model,'shop_point'); ?>
					</div>
