...
$this->breadcrumbs=array(
	'ระบบแบบสอบถาม (ไม่ผูกบทเรียน)'=>array('Questionnaireout/index'),
	'รายงานแบบสอบถาม',
);
...
<div class="innerLR">
	...
	<div class="widget" style="margin-top: -1px;">
		<div class="widget-head">
			<h4 class="heading glyphicons show_thumbnails_with_lines"><i></i> <?php echo $titleName/*." ของ ".*///$header->survey_name;?>
            </h4>
		</div>
    ...
    ?>
            <h4><?php echo $header->survey_name; ?></h4>
...
?>
                        ...
                        if(count($questionValue->choices) > 0){
                        	...
                        	$countArray = array();
                        	$dataArray = array();
                        	$dataArray[] = array('คำถาม', 'เปอร์เซ็นต์');
                            foreach ($questionValue->choices as $choiceKey => $choiceValue) {
                            	$label = $choiceValue->option_choice_name;
...
<?php
    ...
    ?>
            <a href="<?=Yii::app()->createUrl('Questionnaireout/excel',array('id'=>$_GET['id']));?>" id="btnExport" class="btn btn-primary btn-icon glyphicons file"><i></i> Export</a>
        </div>
	</div>
</div>
