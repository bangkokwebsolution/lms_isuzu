<?php
$titleName = 'จักการ Employee Class';
$formNameModel = 'EmpClass';
...
Yii::app()->clientScript->registerScript('updateGridView', <<<EOD
	...
	$.appendFilter("EmpClass[news_per_page]", "news_per_page");
EOD
			...
			<div class="separator bottom form-inline small">
				<?php if (Controller::PButton(array($formNameModel.".create"))) { ?>
					<div class="btn-group" role="group" aria-label="...">
						<a href="<?= Yii::app()->controller->createUrl('create'); ?>" type="button" class="btn btn-danger"><i class="fa fa-plus" aria-hidden="true"></i> เพิ่ม Employee Class</a>
					</div>
				<?php } ?>
			...
			<div class="overflow-table">
				<?php $this->widget('AGridView', array(
					...
					'afterAjaxUpdate'=>'function(id, data){
						$.appendFilter("EmpClass[news_per_page]");
						InitialSortTable();
					}',
					'columns'=>array(
						array(
			   ...
			   //              ),
						...
						array(
							'name'=>'create_date',
							'value'=>'Helpers::changeFormatDate($data->create_date,"datetime")',
							// 'filter'=>CHtml::activeTextField($model,'cates_search'),  
						),
							...
							'value'=>function($data){
								...
								$text .= '
								<a class="btn-action glyphicons pencil btn-success" title="แก้ไข" href="'.Yii::app()->controller->createUrl('EmployeeClass/update/'.$data->id).'"><i></i></a>
								';
