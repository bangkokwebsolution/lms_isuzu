...
<?php
$titleName = 'รายงานผู้เรียนตามประเภทธุรกิจ';
...
<div class="innerLR">
    ...
    $this->widget('AdvanceSearchForm', array(
        ...
        'attributes'=>array(
            ...
            array('name'=>'BusinessType','type'=>'list','query'=>BusinessType::getTypeList()),
                ...
                <div class="widget-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th class="center" style="width: 150px;">ประเภทธุรกิจ</th>
                    ...
                    if ($DataProvinceInfor != "") {
                        ...
                        WHERE status='1' AND tbl_profiles.generation='".$DataProvinceInfor['generation']."' ";
                        ...
                        $sqlProvince .= " AND tbl_users.create_at between '".$startDate."' and '".$endDate."' ";
                           if($model->BusinessType !='') {
                                $sqlProvince .= " AND tbl_profiles.bussiness_type_id = '".$model->BusinessType."' ";
                            }
                        $sqlProvince .= " AND bussiness_type_id NOT LIKE '%''%'";
                        $sqlProvince .= " GROUP BY bussiness_type_id";

                        $provinceData = Yii::app()->db->createCommand($sqlProvince)->queryAll();
                        foreach ($provinceData as $key => $reprotPro) {
                            $bussiness = BusinessType::model()->findByPk($reprotPro['bussiness_type_id']);
...
Yii::app()->clientScript->registerScript('chart', "
    ...
    // Load the Visualization API and the piechart package.
      ...
      function drawChart() {
        ...
        data.addColumn('number', '%จำนวนผู้เรียนตามประเภทธุรกิจ');
        data.addRows([
          ".$data."
        ]);
        ...
        // Set chart options
        var options = {
        'title':'%จำนวนผู้เรียนตามประเภทธุรกิจ',
        'width':'%100',
        is3D: true,
        //'height':300
        };
