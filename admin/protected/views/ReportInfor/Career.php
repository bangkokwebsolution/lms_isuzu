...
<div class="innerLR">
    ...
    $this->widget('AdvanceSearchForm', array(
        ...
        'attributes'=>array(
            ...
            array('name'=>'occupation','type'=>'list','query'=>Profiles::getOccupationList()),
                ...
                <div class="widget-body div-table">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th class="center" style="width: 150px;">อาชีพ</th>
                    ...
                    if ($DataProvinceInfor != "") {
                        ...
                        $sqlProvince .= " AND tbl_users.create_at between '".$startDate."' and '".$endDate."' ";
                           if($model->occupation !='') {
                                $sqlProvince .= " AND tbl_profiles.occupation = '".$model->occupation."' ";
                            }

                        $sqlProvince .= ' GROUP BY occupation';

                        $provinceData = Yii::app()->db->createCommand($sqlProvince)->queryAll();
                        foreach ($provinceData as $key => $reprotPro) {
                            $data .= "['" . $reprotPro['occupation'] . "',   " . $reprotPro['user'] . "],"; 
                        ?>
                        <tr>
                            <td class="center"><?php echo $i; ?></td>  
                            <td><?php echo $reprotPro['occupation']; ?></td>
...
Yii::app()->clientScript->registerScript('chart', "
    ...
    // Load the Visualization API and the piechart package.
      ...
      function drawChart() {
        ...
        data.addColumn('number', '%จำนวนผู้เรียนตามอาชีพ');
        data.addRows([
          ".$data."
        ]);
