...
<script type="text/javascript">
    ...
    function deleteVdo(vdo_id, file_id) {
        $.get("<?php echo $this->createUrl('lesson/deleteVdo'); ?>", {
            id: file_id
        }, function(data) {
            if ($.trim(data) == 1) {
                notyfy({
    ...
    function deleteFileDoc(filedoc_id, file_id) {
        $.get("<?php echo $this->createUrl('lesson/deleteFileDoc'); ?>", {
            id: file_id
        }, function(data) {
            if ($.trim(data) == 1) {
                notyfy({
    ...
    function deleteFilepdf(filedoc_id, file_id) {
        $.get("<?php echo $this->createUrl('lesson/deleteFilePdf'); ?>", {
            id: file_id
        }, function(data) {
            if ($.trim(data) == 1) {
                notyfy({
    ...
    function editName(filedoc_id) {
        ...
        $.get("<?php echo $this->createUrl('lesson/editName'); ?>", {
            id: filedoc_id,
            name: name
        }, function(data) {
        ...
        <div class="widget-body">
            <div class="form">
                ...
                <div class="row">
                    ...
                    <select name="Lesson[status]" class="span8" <?= $readonly == true ? 'disabled="disabled"' : "" ?>>
                        <?php
                        $list_Lesson_refer = ["Close" => "ไม่เลือกเฉลย", "AnswerAfter" => "เฉลยข้อสอบภายหลัง", "AnswerByOne" => "เฉลยข้อสอบทีละข้อ"];
