    <h4 style="color: red;">
        ***เมื่อ Reset สอบหลังเรียน การสอบวัดผลจะถูก Reset ไปด้วย***
    </h4>
    <form method='post'>
                        ...
                        <td>
                            <ul style='list-style-type: none;'>
                             ...
                             $modelcourse = Score::model()->findAll(array(
                                'condition'=>'course_id=:course_id AND type="post" AND active="y" AND gen_id=:gen_id AND user_id=:user_id GROUP BY lesson_id ,gen_id',
