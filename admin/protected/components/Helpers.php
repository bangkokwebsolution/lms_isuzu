    ...
    public function checkLessonPass_Percent($lesson,$user_id,$format=null, $gen_id=null)
{
    ...
    public function ApprovalSpecifically($course_id){
        ...
        // }elseif ($user_hr1 != null && $user_org->level == 4 && $user_hr1->orgchart->level <= $user_org->level && ($user_org->id == $user_hr1->org_id || $user_org->orgchart->id == $user_hr1->org_id || $user_org->div->id ==  $user_hr1->org_id || $user_org->dep->id ==  $user_hr1->org_id ) && $course->create_by != Yii::app()->user->id) {

        //     $ceh = 1;

        // }elseif ($user_hr1 != null && $user_org->level == 5 && $user_hr1->orgchart->level <= $user_org->level && ($user_org->id == $user_hr1->org_id || $user_org->orgchart->id == $user_hr1->org_id || $user_org->div->id ==  $user_hr1->org_id || $user_org->dep->id ==  $user_hr1->org_id || $user_org->gro->id ==  $user_hr1->org_id ) && $course->create_by != Yii::app()->user->id) {
