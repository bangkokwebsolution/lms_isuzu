...
//            array('name'=>'course','type'=>'list','query'=>$model->courseList),
		...
		<div class="widget" style="margin-top: -1px;">
			<div class="widget-head">
				<h4 class="heading glyphicons show_thumbnails_with_lines"><i></i>ระบบบริหารจัดการ E learning - จัดการการเข้าใช้งาน <?php //echo $this->pageTitle=Yii::app()->name . ' - '.UserModule::t("Confirm Registration"); ?></h4>
			</div>
		...
		// 'lastvisit_at',
								...
								array(
									'type'=>'raw',
									'value'=>function($data){
											echo CHtml::button("ลบ",array("class"=>"btn btn-success changeStatus","data-id" => $data->id));			
									},
									'header' => 'จัดการ',
