   ...
   public function filters()
		...
		if(isset($_POST['Knowledge']))
		{
			...
			if($model->validate())
			{
				if($model->save())
				{
		        	...
		        	{
						Yii::app()->getDeleteImageYush('knowledge',$model->id,$imageShow);
		        	}
	...
	public function actionDelete($id)
	{
        ...
        if($model->cms_picture != '')
        	Yii::app()->getDeleteImageYush('knowledge',$model->id,$model->cms_picture);
	...
	{
		$model=Knowledge::model()->knowledgecheck()->findByPk($id);
		if($model===null)
