...
class ImgslideLinkController extends Controller
{
	...
	{
		$model=new ImgslideLink;

		if(isset($_POST['ImgslideLink']))
		{
			$time = date("dmYHis");
			$model->attributes=$_POST['ImgslideLink'];
	...
	{
		$model=new ImgslideLink('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ImgslideLink']))
			$model->attributes=$_GET['ImgslideLink'];
	...
	{
		$model=ImgslideLink::model()->imgslidelinkcheck()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='imgslide-link-form')
		{
