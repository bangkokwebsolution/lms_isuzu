	...
	public function accessRules()
	{
		return array(
			array(
				...
				'actions' => array('PrintCertificate', 'PrintPDF', 'ajaxgetdepartment', 'ajaxgetposition', 'ajaxgetgenid','ajaxgetLessonId', 'ExcelIndex', 'DownloadIndex'),
				'users' => array('*'),
			),
			array(
				'allow',
...
<?php
	...
	public function actionajaxgetLessonId()
	{
		$list = "";
		if (isset($_POST["value"]) && $_POST["value"] != "") {
			...
			$list .= '<option value="">กรุณาเลือกบทเรียน</option>';
