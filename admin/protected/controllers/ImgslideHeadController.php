...
class ImgslideHeadController extends Controller
{
	...
	{
		$model=new ImgslideHead;

		if(isset($_POST['ImgslideHead']))
		{
			$time = date("dmYHis");
			$model->attributes=$_POST['ImgslideHead'];
		...
		if(isset($_POST['ImgslideHead']))
		{
			...
			if($model->validate())
			{
				if($model->save())
				{
		        	...
		        	{
						Yii::app()->getDeleteImageYush('imgslidehead',$model->id,$imageShow);
		        	}
	...
	public function actionDelete($id)
	{
        ...
        if($model->imgslide_picture != '')
        	Yii::app()->getDeleteImageYush('Imgslidehead',$model->id,$model->imgslide_picture);
	...
	{
		$model=new ImgslideHead('search');
		$model->unsetAttributes();
		if(isset($_GET['ImgslideHead']))
			$model->attributes=$_GET['ImgslideHead'];
	...
	{
		$model=ImgslideHead::model()->imgslideheadcheck()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='imgslide-head-form')
		{
