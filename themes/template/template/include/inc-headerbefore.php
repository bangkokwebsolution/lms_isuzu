    ...
    <nav class="main-header navbar navbar-expand-lg navbar-light bg-white border-bottom" id="header-main">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerMain">
            ...
            <div class="btn-group-nav">
                ...
                <a class="btn btn-outline-dark btn-login" href="login.php" role="button"><img src="themes/template/images/btn-login.svg" alt=""> เข้าสู่ระบบ</a>
                <a class="btn btn-danger btn-register" href="register-1.php" role="button"><img src="themes/template/images/btn-register.svg" alt=""> สมัครสมาชิก</a>
                ...
                <div class="dropdown account-user">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownAccountuser">
                        ...
                        <a class="dropdown-item" href="#"><i class="fas fa-tasks"></i>สถานะการเรียน</a>
