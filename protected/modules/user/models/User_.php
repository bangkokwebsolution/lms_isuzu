...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((get_class(Yii::app())=='CConsoleApplication' || (get_class(Yii::app())!='CConsoleApplication' && Yii::app()->getModule('user')->isAdmin()))?array(
			...
			array('id, username, password, pic_user, email, activkey, create_at, lastvisit_at, superuser, status', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
        ...
        // $relations['courses'] = array(
        //     self::HAS_MANY, 'CourseOrgchart', array('department_id'=>'department_id'),'through'=>'department'
        // );
        ...
        // $relations['ownerLessons'] = array(
        //     self::HAS_MANY,'Lesson',array('course_id'=>'course_id'),'through'=>'ownerCourseOnline'
        // );

        // $relations['ownerVdos'] = array(
        //     self::HAS_MANY,'File',array('id'=>'lesson_id'),'through'=>'ownerLessons'
        // );
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, email, activkey, create_at, superuser, status',
            ),
        );
    }
	...
	public function defaultScope()
    {
        return CMap::mergeArray(Yii::app()->getModule('user')->defaultScope,array(
            'alias'=>'user',
            'select' => 'user.id, user.username, user.email, user.create_at, user.lastvisit_at, user.superuser, user.status, user.department_id',
        ));
    }
