...
/**
 * This is the model class for table "{{file_edu}}".
 *
 * The followings are the available columns in table '{{file_edu}}':
 * @property integer $id
 ...
 */
class FileEdu extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, file_name, filename, length, create_date, create_by, update_date, active', 'safe', 'on'=>'search'),
		);
	}
