...
<tbody class="category">
	<tr>
		...
		<td rowspan="2" style="width:140px;">
			<?php echo CHtml::button(Yii::t('BbiiModule.bbii','Edit'), array('onclick'=>'editCategory(' . $data->id . ',"' . Yii::t('BbiiModule.bbii','Edit category') . '", "' . $this->createAbsoluteUrl('setting/getForum') .'")', 'class'=>'btn btn-primary')); ?>
		</td>
	</tr>
	<tr>
		<td class="header4">
