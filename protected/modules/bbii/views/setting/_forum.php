...
<tbody class="forum">
	<tr>
		...
		<td rowspan="2" style="width:140px;">
			<?php echo CHtml::button(Yii::t('BbiiModule.bbii','Edit'), array('onclick'=>'editForum(' . $forumdata->id . ',"' . Yii::t('BbiiModule.bbii','Edit forum') . '", "' . $this->createAbsoluteUrl('setting/getForum') .'")', 'class'=>'btn btn-primary')); ?>
