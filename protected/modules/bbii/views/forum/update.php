...
$item = array(
	array('label'=>Yii::t('bbii', 'เว็บบอร์ด'), 'url'=>array('/forum/forum/index'), 'linkOptions'=>array('class'=>'btn btn-primary')),
	array('label'=>Yii::t('bbii', 'สมาชิก'), 'url'=>array('/forum/member/index'), 'linkOptions'=>array('class'=>'btn btn-primary'))
);
?>
<style>
	.list-view .summary{
