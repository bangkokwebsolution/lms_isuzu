    ...
    <div class="page-section">
        <div class="row">
                    ...
                    <div class="item col-xs-12 col-sm-6 col-lg-4">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            ...
                            <span class="img icon-block height-150 bg-default"></span>
                                ...
                                <a href="<?php echo $this->createUrl('course/detail',array('id'=>$course_online_data->course_id)); ?>" class="overlay overlay-full overlay-hover overlay-bg-white">
                                    <span class="v-center">
                        ...
                        <div class="panel-body height-100">
                            <h4 class="text-headline margin-v-0-10" style="font-size: 23px;"><a
                                    href="<?php echo $this->createUrl('course/detail',array('id'=>$course_online_data->course_id)); ?>"><?= $course_online_data->course_title; ?></a> <?php if(Helpers::lib()->checkCoursePass($course_online_data->course_id) == "pass"){ ?><i class="fa fa-check-circle text-success"></i><?php } ?>
                            </h4>
                        </div>
            ...
            <?php $this->widget('CLinkPager', array(
                'pages' => $course_online->pagination,
                'header' => '',
                'maxButtonCount' => 6,
                    ...
                    <div class="form-group input-group margin-none">
                        <div class="row margin-none">
                            <div class="col-xs-12 padding-none">
                                <input class="form-control" type="text" name="search_text" placeholder="คำค้นหา" value="<?php echo $_POST['search_text']; ?>" />
                            </div>
                        </div>
