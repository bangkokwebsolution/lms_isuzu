...
<div class="b size38 <?= $fontType ?>" style="position:absolute; top: 65mm; left: -220px;">
    <?= $model['fulltitle'] ?>
</div>

<?php ( mb_detect_encoding($model['courseTitle']) == 'ASCII')? $fontType = 'eng' : $fontType = 'th'; ?>
<div class="size30 black <?= $fontType ?> l" style="position:absolute; top: 110mm; left: 80px; width: 600px;word-wrap: break-word;">
...
<div class="size16 black eng" style="position:absolute; top: 148mm; left: -157px">
  ...
  <?php if ($model['renderSign']) {?>
    ...
    <div style="position:absolute; left: 133mm; top: 83mm" >
