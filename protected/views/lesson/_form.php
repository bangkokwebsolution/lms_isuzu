...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'cate_amount'); ?>
		<?php echo $form->error($model,'cate_amount'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'cate_percent'); ?>
		<?php echo $form->textField($model,'cate_percent'); ?>
		<?php echo $form->error($model,'cate_percent'); ?>
	</div>
