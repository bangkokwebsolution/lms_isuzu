    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-main">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <?php
                if (Yii::app()->session['lang'] == 1) {
                    echo "Training Overview Report";
                } else{
                    echo "รายงานภาพรวมการฝึกอบรม";
                }
                ?>
            </li>
        </ol>
...
<script type="text/javascript">
    $(document).ready( function () {
        ...
        $('.btn-excel').click(function(e) {
            window.open('data:application/vnd.ms-excel;charset=UTF-8;,' + encodeURIComponent("<h2>Training Overview Report</h2>"+$('#result_search_graph').html()+'<br><br><br><br><br><br><br><br><br><br><br><br><font color="white">ตาราง</font>'+$('#result_search').html() ));
            e.preventDefault();
        });
