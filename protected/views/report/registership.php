        ...
        <ol class="breadcrumb breadcrumb-main">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                ...
                if (Yii::app()->session['lang'] == 1) {
                    ...
                    echo "รายงานการสมัครสมาชิกพนักงานประจำเรือ";
                }
                ?>
            </li>
        </ol>
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <div><label><?= Yii::app()->session['lang'] == 1?'Chart Type':'รูปแบบกราฟ'; ?></label></div>
                            ...
                            <div class="col-sm-3 col-md-3 col-xs-12 tag_status">
                                <div class="form-group">
                                    ...
                                    <select class="form-control status" name="" id="x">
                                        ...
                                        <option value="2"><?= Yii::app()->session['lang'] == 1?'Suspension':'ระงับการใช้งาน'; ?></option>s
                                    </select>
                                </div>
                            </div>
                        </div>
