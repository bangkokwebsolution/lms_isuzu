...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'tquestionnairequestion-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'Que_nID'); ?>
		<?php echo $form->textField($model,'Que_nID'); ?>
		<?php echo $form->error($model,'Que_nID'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'Yna_nID'); ?>
		<?php echo $form->textField($model,'Yna_nID'); ?>
		<?php echo $form->error($model,'Yna_nID'); ?>
	</div>
