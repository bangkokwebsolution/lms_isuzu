                ...
                <div class="col-lg-4 col-xs-12 col-sm-12">
                    ...
                    ?>
                        <video class="video-js" controls preload="auto" style="width: 100%; height: 300;">
                            ...
                            <source src="<?php echo Yii::app()->baseUrl . '/uploads/vdo/'.$vdoshow->vdo_id.'/'. $vdoshow->vdo_path; ?>" type='video/mp4'>
                            <p class="vjs-no-js">
                    ...
                    <?php } ?>
                    <span class="pull-right"><a class="btn mt-1 btn-viewall-recommanded btn-sm" href="<?php echo $this->createUrl('/video/index'); ?>" role="button"><?= $label->label_viewAll ?> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/add.svg"></a></span>
                </div>
