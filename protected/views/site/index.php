        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="page-header">
                    <h1 class="title-topic">
                        <?= $label->label_imgslide ?> <span class="pull-right">
                            <a class="btn btn-viewall btn-sm" href="<?php echo $this->createUrl('/banner/index'); ?>" role="button"><?= $label->label_viewAll ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></span></h1>
                </div>
                <?php
                    ...
                    <div class="carousel-inner">
                        <?php if (!isset($image[0])) { ?>
                            <div class="item active">
                                <img alt="news-thoresen" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide-news.jpg">
                            </div>
                            <div class="item">
                                <img alt="news-thoresen" src="https://via.placeholder.com/1364x580.jpg">
                            </div>
                            <?php } else {
            ...
            <div class="col-sm-4">
                ...
                if ($vdoshow->vdo_type == 'link') {
                    ...
                    $show = '<iframe class="embed-responsive-item" width="100%" height="315"  src="' . $new_link . '" allowfullscreen style="box-shadow:1px 4px 6px #767676"></iframe>';
                    echo $show;
...
<section class="course" style="background-color: #e9eaed; ">
    <div class="container">
        <div class="page-header">
            <h1>
        ...
        <?php } else { ?>
            <div class="col-md-12">
                <div class="well before-login text-center">
                    ...
                    <div class="mg-login">
                        <a class="btn-login-before" data-toggle="modal" href='#modal-login'><i class="fa fa-sign-in" aria-hidden="true"></i>
...
<section class="menu-elearning">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="#" class="btn btn-elearning bg-faq">
                    <div class="row center-align">
                        <div class="col-md-3">
