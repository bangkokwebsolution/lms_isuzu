...
class CategoryController extends Controller
{
	...
	{
		$model_cate = Category::model()->findAllByAttributes(array('active'=>'y','cate_show'=>'1'));
  ...
  //       	if(isset($_POST['User'])){
		...
		// 	$uploadFile = CUploadedFile::getInstance($model,'cardid2');
		// 	if(isset($uploadFile))
		// 	{
		...
		// 		$model->pic_cardid2 = $beautifulName;
		// 	}
		...
		// 						/////////// SAVE IMAGE //////////
		// 						Yush::init($model);
		// 									$originalPath = Yush::getPath($model, Yush::SIZE_ORIGINAL, $model->pic_cardid2);
		// 									$thumbPath = Yush::getPath($model, Yush::SIZE_THUMB, $model->pic_cardid2);
		// 									$smallPath = Yush::getPath($model, Yush::SIZE_SMALL, $model->pic_cardid2);
