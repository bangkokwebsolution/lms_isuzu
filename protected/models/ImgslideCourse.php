...
/**
 * This is the model class for table "{{imgslide_course}}".
 *
 * The followings are the available columns in table '{{imgslide_course}}':
 ...
 */
class ImgslideCourse extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImgslideCourse the static model class
	 */
