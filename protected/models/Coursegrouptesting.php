...
class Coursegrouptesting extends AActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('create_date, update_date,course_search, news_per_page', 'safe'),
			array('course_id, group_title', 'required'),
			array('group_id, course_search, course_id, group_title, step_id, create_date, create_by, update_date, update_by, active', 'safe', 'on'=>'search'),
		);
	}
