...
/**
 * This is the model class for table "{{imgslide_head}}".
 *
 * The followings are the available columns in table '{{imgslide_head}}':
 ...
 */
class ImgslideHead extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImgslideHead the static model class
	 */
