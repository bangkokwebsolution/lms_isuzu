...
/**
 * This is the model class for table "{{imgslide_shop}}".
 *
 * The followings are the available columns in table '{{imgslide_shop}}':
 ...
 */
class ImgslideShop extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImgslideShop the static model class
	 */
