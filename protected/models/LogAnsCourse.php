 ...
 */
class LogAnsCourse extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LogAnsCourse the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id, course_id, user_id, gen_id,temp_id, quest_id', 'numerical', 'integerOnly' => true),
			array('id, course_id, user_id, answer_choice, temp_id, number, status, create_date', 'safe', 'on' => 'search'),
		);
	}
