...
class MenuRegistration extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'label_FileAttachIdentification' => 'Label File Attach Identification',
			'label_FileAttachPassport' => 'Label File Attach Passport',
			'label_FileAttachCrewIdentification' => 'Label File Attach Crew Identification',
			'label_AttachCopiesOfHousePaticular' => 'Label Attach Copies Of House Paticular',
			'label_OwnHouse' => 'Label Own House',
			'label_RentHouse' => 'Label Rent House',
			'label_WithParents' => 'Label With Parents',
			'label_Apartment' => 'Label Apartment',
			'label_WithRelative' => 'Label With Relative',
			'label_Enlisted' => 'Label Enlisted',
			'label_NotEnlisted' => 'Label Not Enlisted',
			'label_Exempt' => 'Label Exempt',
			'label_month' => 'Label Month',
			'label_blood' => 'Label Blood',
			'label_height' => 'Label Height',
			'label_weight' => 'Label Weight',
			'label_addressParent' => 'Label Address Parent',
		);
	}
