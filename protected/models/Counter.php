...
class Counter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('date_visit, ip_visit', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_visit, date_visit, ip_visit, visit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('date_visit',$this->date_visit,true);
		$criteria->compare('ip_visit',$this->ip_visit,true);
