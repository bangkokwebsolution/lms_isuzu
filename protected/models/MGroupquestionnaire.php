...
/**
 * This is the model class for table "m_groupquestionnaire".
 *
 * The followings are the available columns in table 'm_groupquestionnaire':
 ...
 */
class MGroupquestionnaire extends CActiveRecord
{
	/**
	 ...
	 * @return MGroupquestionnaire the static model class
	 */
