...
/**
 * This is the model class for table "{{imgslide_promotion}}".
 *
 * The followings are the available columns in table '{{imgslide_promotion}}':
 ...
 */
class ImgslidePromotion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImgslidePromotion the static model class
	 */
