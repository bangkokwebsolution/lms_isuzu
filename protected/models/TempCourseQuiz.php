...
/**
 * This is the model class for table "temp_course_quiz".
 *
 * The followings are the available columns in table 'temp_course_quiz':
 * @property integer $id
 ...
 */
class TempCourseQuiz extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, course_id, group_id, ques_id, number, ans_id, status, time_start, question, time_up, gen_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'quest' => array(self::BELONGS_TO, 'Coursequestion','ques_id'),
		);
	}
	 ...
	 * @return TempCourseQuiz the static model class
	 */
